...
export  const { licitatii, achizitii } = await getTotal();
...
Contractele de licitatii publice si achizitii directe se actualizeaza zilnic iar in prezent sunt indexate **{licitatii} licitatii publice** si **{achizitii} achizitii directe**.
