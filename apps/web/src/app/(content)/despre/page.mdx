...
export const offline = formatNumber(totals.offline);
...
Contractele de licitatii publice si achizitii directe se actualizeaza zilnic iar in prezent sunt indexate **_{licitatii}_ licitatii publice**, **_{achizitii}_ achizitii directe** si **_{offline}_ achizitii offline**.
