  ...
  return message.parts
    ...
    .map((part) => {
      ...
      if (type.startsWith("data-")) {
        ...
        console.warn(`Data part type ${type} is not yet supported in conversion`);
        return null;
      }
...
export const AISDKMessageConverter = unstable_createMessageConverter((message: UIMessage) => {
