...
ALTER TABLE `account` ALTER COLUMN "createdAt" TO "createdAt" integer NOT NULL;--> statement-breakpoint
...
ALTER TABLE `account` ALTER COLUMN "updatedAt" TO "updatedAt" integer NOT NULL;--> statement-breakpoint
ALTER TABLE `user` ALTER COLUMN "emailVerified" TO "emailVerified" integer NOT NULL;--> statement-breakpoint
ALTER TABLE `user` ALTER COLUMN "createdAt" TO "createdAt" integer NOT NULL;--> statement-breakpoint
ALTER TABLE `user` ALTER COLUMN "updatedAt" TO "updatedAt" integer NOT NULL;